...
struct Constants {
    // Classes for PASCAL VOC dataset
...
//                              labelValue: 0, color: CIColor(red: 0.000, green: 0.000, blue: 0.000),
    ...
    // Classes for CityScapes dataset (All the classes)
    static let CityScapesConstantsFull: SegmentationClassConstants = SegmentationClassConstants(
        classes: [
