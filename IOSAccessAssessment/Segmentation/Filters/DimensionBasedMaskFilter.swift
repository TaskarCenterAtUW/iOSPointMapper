...
//    }
    ...
    func apply(to inputImage: CIImage, minX: Float, maxX: Float, minY: Float, maxY: Float) -> CIImage? {
        ...
        commandEncoder.setBytes(&minXLocal, length: MemoryLayout<UInt8>.size, index: 0)
        commandEncoder.setBytes(&maxXLocal, length: MemoryLayout<UInt8>.size, index: 1)
        commandEncoder.setBytes(&minYLocal, length: MemoryLayout<UInt8>.size, index: 2)
        commandEncoder.setBytes(&maxYLocal, length: MemoryLayout<UInt8>.size, index: 3)
