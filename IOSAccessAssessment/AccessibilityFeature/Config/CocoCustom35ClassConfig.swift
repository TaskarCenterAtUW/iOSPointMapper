...
extension AccessibilityFeatureConfig {
    static let cocoCustom35Config: AccessibilityFeatureClassConfig = AccessibilityFeatureClassConfig(
        ...
        classes: [
            AccessibilityFeatureClass(name: "Road", grayscaleValue: 27.0 / 255.0, labelValue: 27,
                              color: CIColor(red: 0.502, green: 0.251, blue: 0.502),
                              isWay: true,
                              bounds: DimensionBasedMaskBounds(minX: 0.0, maxX: 1.0, minY: 0.1, maxY: 0.5)),
            AccessibilityFeatureClass(name: "Sidewalk", grayscaleValue: 22.0 / 255.0, labelValue: 22,
                              color: CIColor(red: 0.957, green: 0.137, blue: 0.910),
                              isWay: true,
                              bounds: DimensionBasedMaskBounds(minX: 0.0, maxX: 1.0, minY: 0.1, maxY: 0.5)),
            AccessibilityFeatureClass(name: "Building", grayscaleValue: 16.0 / 255.0, labelValue: 16,
                              color: CIColor(red: 0.275, green: 0.275, blue: 0.275)),
            AccessibilityFeatureClass(name: "Wall", grayscaleValue: 33 / 255.0, labelValue: 33,
                              color: CIColor(red: 0.400, green: 0.400, blue: 0.612)),
            AccessibilityFeatureClass(name: "Fence", grayscaleValue: 20.0 / 255.0, labelValue: 20,
                              color: CIColor(red: 0.745, green: 0.600, blue: 0.600)),
            AccessibilityFeatureClass(name: "Pole", grayscaleValue: 21.0 / 255.0, labelValue: 21,
            ...
            AccessibilityFeatureClass(name: "Traffic sign", grayscaleValue: 10.0 / 255.0, labelValue: 10,
                              color: CIColor(red: 0.863, green: 0.863, blue: 0.000)),
            AccessibilityFeatureClass(name: "Vegetation", grayscaleValue: 15.0 / 255.0, labelValue: 15,
                              color: CIColor(red: 0.420, green: 0.557, blue: 0.137)),
            AccessibilityFeatureClass(name: "Terrain", grayscaleValue: 19.0 / 255.0, labelValue: 19,
...
//                              color: CIColor(red: 1.000, green: 0.000, blue: 0.000)),
            ...
            AccessibilityFeatureClass(name: "Train", grayscaleValue: 7.0 / 255.0, labelValue: 7,
                              color: CIColor(red: 0.000, green: 0.314, blue: 0.392)),
            AccessibilityFeatureClass(name: "Motorcycle", grayscaleValue: 4.0 / 255.0, labelValue: 4,
