...
public struct DepthMapProcessor {
     ...
     */
    public func getFeatureDepthAtCentroid(detectedFeature: any DetectedFeatureProtocol) throws -> Float {
    ...
    /**
        ...
        - Note: The centroid coordinates are normalized (0 to 1) and need to be converted to pixel coordinates.
     */
    public func getFeatureDepthAtCentroidInRadius(detectedFeature: any DetectedFeatureProtocol, radius: CGFloat = 5) throws -> Float {
        let featureContourDetails = detectedFeature.contourDetails
        let featureCentroid = featureContourDetails.centroid
    ...
    public func getFeatureDepthsAtBounds(detectedFeature: any DetectedFeatureProtocol) throws -> [Float] {
        let featureContourDetails = detectedFeature.contourDetails
