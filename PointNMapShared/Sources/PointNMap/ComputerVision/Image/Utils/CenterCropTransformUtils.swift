...
public enum CenterCropTransformUtilsError: Error, LocalizedError {
...
public struct CenterCropTransformUtils {
    ...
    public func revertCenterCropAspectFit(_ image: CIImage, to destSize: CGSize) throws -> CIImage {
